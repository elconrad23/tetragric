...
namespace TetragricUI.Pages
{
    public class EmissionsModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            {
                new EmissionLog { Timestamp = DateTime.UtcNow.AddDays(-3), CO2Amount = 45 },
                new EmissionLog { Timestamp = DateTime.UtcNow.AddDays(-2), CO2Amount = 32 },
                new EmissionLog { Timestamp = DateTime.UtcNow.AddDays(-1), CO2Amount = 29 }
            };
        }
    }
}
